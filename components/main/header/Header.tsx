    ...
    <div className="bg-white">
      <header className="inset-x-0 top-0 z-50 fixed bg-white dark:bg-[#141518] border-b border-slate-300 dark:border-zinc-800">
        <nav className="flex items-center justify-between py-1 pt-2 w-11/12 lg:w-11/12 2xl:w-10/12 mx-auto">
          <div className='flex gap-x-6 items-center'>
            ...
            <div className="hidden lg:flex lg:gap-x-12 ">
              {links.map((item) => (
                <NavLink key={item.id} href={item.url} className="text-sm font-semibold text-zinc-800 dark:text-slate-200 hover:dark:text-white hover:bg-slate-200 dark:hover:bg-zinc-800 px-3 py-2 rounded-lg transition">
                  {item.title}
                </NavLink>
              ))}
            </div>
          ...
          <div className="flex div_mobile lg:hidden ">
            ...
            >
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-3xl" aria-hidden="true" focusable="false" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 min-w-full overflow-y-auto bg-white dark:bg-zinc-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div>
              <div className='w-full rounded-3xl ring-1 flex ring-gray-200 items-center justify-between scroll-smooth mt-5 px-2'>
