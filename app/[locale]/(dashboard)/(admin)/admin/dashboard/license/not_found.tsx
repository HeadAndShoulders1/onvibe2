...
export default function InnNotFound() {
    const t = useTranslations('admin_license')
    return (
        <div className="flex items-center p-2 text-base gap-x-2 mt-2 text-red-800 rounded-lg bg-red-100 dark:bg-red-300 dark:text-red-700">
